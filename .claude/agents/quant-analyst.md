...
Use these to get second opinions or delegate specialized reasoning. You orchestrate, they advise.
| Task | Command |
|------|---------|
| Deep strategy/math | `python scripts/ask_model.py -m opus -s "You are a quant analyst." -p "..."` |
| Second opinion | `python scripts/ask_model.py -m deepseek -s "You are a quant analyst." -p "..."` |
| Fast checks | `python scripts/ask_model.py -m sonnet -p "..."` |
